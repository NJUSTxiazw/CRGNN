...
if __name__ == '__main__':
    dataPath = '/data/xiazhengwang/ADNI_TimeSeries'

    interResultPath = '/data/xiazhengwang/CRGNN/interResultPath_ADNI/'
    ...
    for cate in os.listdir(dataPath):
        catePath = dataPath + '/' + cate
        for sub in os.listdir(catePath):
            subPath = catePath + '/' + sub
            for tFile in os.listdir(subPath):
                filePath = subPath + '/' + tFile + '/bold.txt'
    ...
    testResultCSV.to_csv('ADNI.csv', sep=',', index=False, header=True)